...
#define get_index(p0,p1,p2) {self.hash_func}
        ...
        print(f'params: n_features_per_level={n_features_per_level}\nn_levels={n_levels}\nlog2_hashmap_size={log2_hashmap_size}')

        self.encoder = GridEncode(self.hash_func_header, aabb_scale=aabb_scale, n_pos_dims=3, n_features_per_level=n_features_per_level,
                                  n_levels=n_levels, base_resolution=16, log2_hashmap_size=log2_hashmap_size, using_fp16=using_fp16)
